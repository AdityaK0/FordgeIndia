        ...
        <section id="testimonials" className="py-20 bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-5xl mx-auto mb-12">
                    <div className="relative bg-white rounded-3xl shadow-xl p-8 md:p-12 overflow-hidden border border-border-gray">
                        {/* Decorative Elements */}
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-center mb-8">
                                {/* Avatar */}
                                <div className="w-20 h-20 bg-accent/10 rounded-full flex items-center justify-center text-4xl mx-auto mb-6 shadow-md border-2 border-accent/20">
                                ...
                                {/* Text */}
                                <p className="text-xl md:text-2xl text-text-secondary leading-relaxed mb-8 max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                        {testimonials.map((testimonial, index) => (
                            <button
                                key={index}
                                onClick={() => setActiveIndex(index)}
                                className={`p-4 rounded-xl transition-all duration-300 border ${index === activeIndex
                                        ? 'bg-accent text-white shadow-lg scale-105 border-accent'
                                        : 'bg-bg-card hover:bg-bg-light border-border-gray'
                                    }`}
                            >
                                <div className="text-3xl mb-2">{testimonial.image}</div>
                                <p className={`text-sm font-semibold truncate ${index === activeIndex ? 'text-white' : 'text-primary'
                                    }`}>
                                    {testimonial.name}
                                </p>
                                <p className={`text-xs truncate ${index === activeIndex ? 'text-white/80' : 'text-text-secondary'
                                    }`}>
                ...
                <div className="mt-16 flex flex-wrap justify-center items-center gap-8 text-gray-400">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-text-secondary">500+ Happy Vendors</span>
                    </div>
                </div>
            </div>
        </section>
