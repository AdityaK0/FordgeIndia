...
const HowItWorks = () => {
    const steps = [
        ...
        },
        {
            ...
            description: 'Get your personalized portfolio URL instantly: https://<business-name>.fordgeindia.online — share it with customers and start building your online presence.',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
